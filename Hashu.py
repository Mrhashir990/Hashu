...
def banner():
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %sHASHU                   %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : https://github.com/Mrhashir990  %s║"%(Z,B,Z))
	print("%s║%s  Facebook : Mr bobby       %s║"%(Z,B,Z))
	print("%s║%s  Version  : %s3.0                          %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
	xox('            %s》%s》%s》%sBOBBY BOLTI PUBLIC%s《%s《%s《'%(M,H,B,H,B,H,M))
	print("")
